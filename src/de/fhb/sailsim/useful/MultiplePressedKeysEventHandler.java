...
public class MultiplePressedKeysEventHandler implements EventHandler<KeyEvent> {
    ...
    public MultiplePressedKeysEventHandler(final MultiKeyEventHandler multiKeyEventHandler2) {
        this.multiKeyEventHandler = multiKeyEventHandler2;
    }
